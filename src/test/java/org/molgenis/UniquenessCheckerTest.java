...
class UniquenessCheckerTest {
  ...
  HashMap getVariant(String chromosome, int position, String ref, String alt, String gene,
      String hgvs) {
  ...
  void getUniqueVariantsListTest() {
    ...
    HashMap variantD = getVariant("3", 123456, "C", "T", "ABCD3", "NC_000001.10:g.123456C>T");
    variantD.put("error", "some error message");
    List body = new ArrayList<>(Arrays.asList(variantA, variantB, variantC, variantD));
    ...
    variantAError.put("error", "Variant duplicated: NC_000001.10:g.1234A>G,NC_000001.10:g.1234A>G");
